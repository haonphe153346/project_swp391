...
public class feedback {
    ...
    public feedback(int feedback_id, int user_id, int reservation_id, String content, String name, boolean gender, String email, String mobile, String feedback_image) {
