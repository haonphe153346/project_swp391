...
public class reservationdetail {
    ...
    public reservationdetail(int reservation_detail_id, int reservation_id, int service_id, float price, int quantity, int num_of_person, int category_id, int doctor_id, int nurse_id, Date begin_time) {
