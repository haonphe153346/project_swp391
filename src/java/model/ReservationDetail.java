...
public class ReservationDetail {
    ...
    public ReservationDetail(int reservationDetail_id, int reservation_id, int service_id, float price, int quantity, int numOfPerson, int category_id, int doctor_id, int nurse_id, Date begin_time, int slot) {
