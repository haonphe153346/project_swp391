...
public class MyReservation {
    ...
    public MyReservation(int reservation_id, String service_title, Date created_date, Date begin_time, int number_of_person, int reservation_status, float total_price, String image, int slot) {
