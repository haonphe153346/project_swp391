...
<body>
  ...
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
        <p><span class="h2">Your Reservation Detail   </span><span class="h4">(1 item in your cart)</span></p>
        ...
        <div class="card mb-4">
          <div class="card-body p-4">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-2 d-flex justify-content-center">
                <div>
                  <p class="small text-muted mb-4 pb-2">Number of person</p>
                  <input class="lead fw-normal mb-0 cart-quantity-input" type="number" value="1">
                </div>
              </div>
              <div class="col-md-2 d-flex justify-content-center">
                <div>
