                                    ...
                                    <c:forEach items="${listService}" var="i">
                                        <div class="services row p-2 bg-white border rounded mt-2">
                                            ...
                                            <div class="align-items-center align-content-center col-md-3 border-left mt-1">
                                                ...
                                                <div class="d-flex flex-column mt-4"><button class="btn btn-primary btn-sm" type="button">Details</button><button onclick="addToCardAsync(${i.service_id})" class="btn btn-outline-primary btn-sm mt-2" type="button">Add to card</button></div>
