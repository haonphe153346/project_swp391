                    ...
                    <form action="settingdetail" method="post">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="radio" name="status" value="1" ${setting.setting_status == true?"checked":""}> active<br>
                                    <input type="radio" name="status" value="0" ${setting.setting_status == false?"checked":""}> not active
                                </td>
                                <td>
